      ...
      <div className="container mx-auto py-8 mt-12">
        ...
        <div className="flex flex-wrap justify-center gap-4 animate-fade-in-down">
          {technos.map((techno, index) => (
            <div key={index} className="md:w-300 p-8 min-w-260 bg-gray-800 backdrop-blur-md rounded-3xl flex flex-col justify-center drop-shadow-lg gap-4 hover:scale-105 transition-all duration-300">
              <div className="p-6">
              ...
              <div className=" py-3 px-4 text-right">
                <button
                  className="px-2 py-1 rounded-lg bg-teal-800 font-semibold text-white mt-24"
